...
function MY_PostsTypeWidget() {
		$widget_ops = array('classname' => 'my_posts_type_widget', 'description' => __('Show custom posts', 'theme1599'));
		$control_ops = array('width' => 500, 'height' => 350);
	    parent::WP_Widget(false, __('My - Advanced Cycle', 'theme1599'), $widget_ops, $control_ops);
}
...
<div style="width:230px; float:left; padding-right:20px; border-right:1px solid #c7c7c7;">
  ...
  <p>
      <label for="<?php echo $this->get_field_id("num"); ?>">
          <?php _e('Number of posts to show', 'theme1599'); ?>:
...
<p>
  ...
  <input type="checkbox" class="checkbox" 
    ...
    <?php checked( (bool) $instance["asc_sort_order"], true ); ?> />
          <?php _e( 'Reverse sort order (ascending)', 'theme1599' ); ?>
      </label>
</p>
<p>
  <label for="<?php echo $this->get_field_id("comment_num"); ?>">
      <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("comment_num"); ?>" name="<?php echo $this->get_field_name("comment_num"); ?>"<?php checked( (bool) $instance["comment_num"], true ); ?> />
      <?php _e( 'Show number of comments', 'theme1599' ); ?>
  </label>
</p>
...
<p>
  <label for="<?php echo $this->get_field_id("date"); ?>">
      ...
      <?php _e( 'Show meta', 'theme1599' ); ?>
  </label>
</p>

<p>
  <label for="<?php echo $this->get_field_id("container_class"); ?>">
    <?php _e( 'Container class', 'theme1599' ); ?>:
    <input class="widefat" id="<?php echo $this->get_field_id("container_class"); ?>" name="<?php echo $this->get_field_name("container_class"); ?>" type="text" value="<?php echo esc_attr($instance["container_class"]); ?>" /> <span style="font-size:11px; color:#999;"><?php _e( '(default: "featured_custom_posts")', 'theme1599' ); ?></span>
  </label>
</p>

  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Post title', 'theme1599'); ?>:</legend>
  <p>
      <label for="<?php echo $this->get_field_id("show_title"); ?>">
          ...
          <?php _e( 'Show post title', 'theme1599' ); ?>
      </label>
  </p>
  <p>
      <label for="<?php echo $this->get_field_id("show_title_date"); ?>">
          ...
          <?php _e( 'Date as title <span style="font-size:11px; color:#999;">("[mm-dd-yyyy]")</span>', 'theme1599' ); ?>
      </label>
  </p>
  <p>
      <label for="<?php echo $this->get_field_id("before_post_title"); ?>">
          <?php _e( 'Before title', 'theme1599' ); ?>:
  ...
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Excerpt', 'theme1599'); ?>:</legend>
  <p>
      <label for="<?php echo $this->get_field_id("excerpt"); ?>">
          <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("excerpt"); ?>" name="<?php echo $this->get_field_name("excerpt"); ?>"<?php checked( (bool) $instance["excerpt"], true ); ?> />
          <?php _e( 'Show post excerpt', 'theme1599' ); ?>
      </label>
  </p>
  <p>
      <label for="<?php echo $this->get_field_id("excerpt_length"); ?>">
          <?php _e( 'Excerpt length (words):', 'theme1599' ); ?>
      </label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id("excerpt_as_link"); ?>">
          ...
          <?php _e( 'Excerpt as link', 'theme1599' ); ?>
      </label>
  </p>
  </fieldset>
</div>
<div style="width:230px; float:left; padding-left:20px;">
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('More link', 'theme1599'); ?>:</legend>
  <p>
  ...
  <label for="<?php echo $this->get_field_id("more_link_class"); ?>">
    <?php _e( 'Link class', 'theme1599' ); ?>:
    <input class="widefat" id="<?php echo $this->get_field_id("more_link_class"); ?>" name="<?php echo $this->get_field_name("more_link_class"); ?>" type="text" value="<?php echo esc_attr($instance["more_link_class"]); ?>" /> <span style="font-size:11px; color:#999;"><?php _e( '(default: "link")', 'theme1599' ); ?></span>
  </label>
  </p>
  </fieldset>
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Thumbnail dimensions', 'theme1599'); ?>:</legend>
  <?php if ( function_exists('the_post_thumbnail') && current_theme_supports("post-thumbnails") ) : ?>
  <p>
      <label for="<?php echo $this->get_field_id("thumb"); ?>">
          <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("thumb"); ?>" name="<?php echo $this->get_field_name("thumb"); ?>"<?php checked( (bool) $instance["thumb"], true ); ?> />
          <?php _e( 'Show post thumbnail', 'theme1599' ); ?>
      </label>
  </p>
  <p>
  ...
  <p>
      <label for="<?php echo $this->get_field_id("thumb_as_link"); ?>">
          ...
          <?php _e( 'Thumbnail as link', 'theme1599' ); ?>
      </label>
  </p>
  </fieldset>
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Link to all posts', 'theme1599'); ?>:</legend>
  <p>
      <label for="<?php echo $this->get_field_id("global_link"); ?>">
          ...
          <?php _e( 'Show global link to all posts', 'theme1599' ); ?>
      </label>
  </p>
  <p>
