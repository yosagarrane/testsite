...
if( ! class_exists('Wbls_Customizer_API_Wrapper') ) {
	class Wbls_Customizer_API_Wrapper {
		...
		public function enqueue_scripts() {
			...
			wp_localize_script( 'customizer-js', 'curtains_upgrade', array( 'message' => __( 'Get Pro for just $39', 'curtains' ), 'docs' => __( 'Documentation', 'curtains' ), 'demo' => __( 'Demo', 'curtains' ), 'support' => __( 'Ask a Question', 'curtains' ) ) );
		}
